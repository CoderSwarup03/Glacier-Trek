...
async function loadTrekDetails(slug) {
  try {
    ...
    if (bannerImage.length > 0) {
      ...
      heroImage.src = "./images/blog-banner.jpg";
    }
    trekBannerHeading.innerText=trekData.name || "";
    bannerHeading.innerText = trekData.name || "Trek Title";
    pagecontent.innerHTML =
    ...
    // img.src = image.data || "./images/trek1.webp";
    ...
    : packageData.originalPriceINR;
        ...
        ladakhTrack.innerHTML += `
       <div
                        class="ladakh-card group w-[88%] sm:w-[70%] md:w-[48%] lg:w-[31.8%] xl:w-[23.5%] shrink-0 h-full flex flex-col overflow-hidden rounded-[24px] border border-[#e7eddc] bg-white shadow-sm transition-all duration-300 hover:-translate-y-1.5 hover:shadow-xl">
                        <div class="relative overflow-hidden">
                            <img src="${packageData.gallery && packageData.gallery.length > 0 ? packageData.gallery[0].url : "./images/trek1.webp"}" alt="Nun Kun Ladakh" loading="lazy"
                                decoding="async"
                        ...
                        <div class="flex flex-1 flex-col gap-4 p-4">
                            ...
                            <div class=" abc mt-auto grid grid-cols-2 gap-2.5">
                                ...
                                <a href="/booking.html?price=${price}&id=${packageData._id}&name=${packageData.packageName}"
                        ...
                        <div class="relative z-10 flex flex-col justify-end h-full p-6">
                            <div>
                                ...
                                <div class="grid grid-cols-2 gap-3">
                                    <a href="package.html?slug=${singlepackage.slug}"
                                    ...
                                    <a href="/booking.html?price=${price}&id=${singlepackage._id}&name=${singlepackage.packageName}"
