...
// Calculate Discount Percentage
    ...
    if (packageData) {
      ...
      const fullContent =
        packageData.overview? packageData.overview : "N/A";
      // const fullContent =
  ...
  `;
    ...
    // availableDateData.forEach((date) => {
    //   // console.log("Processing Date:", date.month);
    ...
    bookingSummary.innerHTML = `
                                    ...
                                    <a href="/booking.html?price=${tourPrice}&id=${packageData._id}&name=${packageData.packageName}">
                                        <button
                                            class="inline-flex items-center justify-center gap-2 rounded-xl bg-[#d5e880] px-4 py-3 text-sm md:text-base font-semibold text-[#243146] shadow-[0_10px_24px_rgba(213,232,128,0.24)] transition-all duration-300 hover:bg-[#cfe46f]">
                                            <svg class="h-4 w-4" fill="none" stroke="currentColor" stroke-width="2"
                                                viewBox="0 0 24 24">
                                                <path stroke-linecap="round" stroke-linejoin="round" d="M3 20h18">
                                                </path>
                                                <path stroke-linecap="round" stroke-linejoin="round"
                                                    d="M5 16l5-2 3 2 6-8"></path>
                                                <path stroke-linecap="round" stroke-linejoin="round" d="M17 8h2v2">
                                                </path>
                                            </svg>
                                            Book Tour
                                        </button>
